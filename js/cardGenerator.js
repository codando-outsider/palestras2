...
function generateEvent(container, date, title, tags, summary, eventLink, recordingLink) {
	...
	/*cardTags.textContent = tags;*/
		...
		cardTag1.classList.add("tag", "comunicando");
		cardTag1.textContent = "Comunicando";
		var cardTag3 = document.createElement("div");
		cardTag1.classList.add("tag", "cuidando");
		cardTag1.textContent = "Cuidando";
		var cardTag4 = document.createElement("div");
		cardTag1.classList.add("tag", "desembolando");
		cardTag1.textContent = "Desembolando";
		var cardTag5 = document.createElement("div");
		cardTag1.classList.add("tag", "endireitando");
		cardTag1.textContent = "Endireitando";
		var cardTag6 = document.createElement("div");
		cardTag1.classList.add("tag", "engenheirando");
		cardTag1.textContent = "Engenheirando";
		var cardTag7 = document.createElement("div");
		cardTag1.classList.add("tag", "ensinando");
		cardTag1.textContent = "Ensinando";
		var cardTag8 = document.createElement("div");
		cardTag1.classList.add("tag", "negociando");
		cardTag1.textContent = "Negociando";
		var cardTag9 = document.createElement("div");
		cardTag1.classList.add("tag", "projetando");
		cardTag1.textContent = "Projetando";
		var cardTag10 = document.createElement("div");
		cardTag2.classList.add("tag", "veterinando");
		cardTag2.textContent = "Veterinando";
